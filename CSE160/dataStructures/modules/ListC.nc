...
generic module ListC(typedef t, int n){
	/*you can make multiple copies of the ListC component and give each instantiation of the component
	a different type of list and size depending on the arguments:typedef t(type of data), int n(size)
	 as well as providing List<c> interface with defined commands to select/fill in the list
	*/
